 ...
 * `+`, p.ej. `34644123456`). Si no hay número configurado el componente no
 * renderiza nada (mejor ocultarlo que enseñar un enlace roto). El mensaje
...
export function WhatsappButton() {
  ...
  const text = process.env.NEXT_PUBLIC_WHATSAPP_TEXT ?? 'Hola RT Bunker, tengo una consulta'
